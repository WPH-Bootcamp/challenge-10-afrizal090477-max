    ...
    >
      ...
      <div className="flex flex-col gap-[16px] w-full">
        ...
        <button className="flex items-center gap-[8px] h-[30px] w-[150px] text-left cursor-pointer group">
          <MapPin className={`w-[24px] h-[24px] ${activeMenu === "address" ? "text-[#C12116]" : "text-[#0A0D12]"}`} />
          <span className={`text-[16px] font-[500] tracking-[-3%] ${activeMenu === "address" ? "text-[#C12116]" : "text-[#0A0D12]"}`}>
            Delivery Address
          </span>
        </button>

        <button className="flex items-center gap-[8px] h-[30px] w-[104px] text-left cursor-pointer group">
          <ShoppingBag className={`w-[24px] h-[24px] ${activeMenu === "orders" ? "text-[#C12116]" : "text-[#0A0D12]"}`} />
          <span className={`text-[16px] font-[500] tracking-[-3%] ${activeMenu === "orders" ? "text-[#C12116]" : "text-[#0A0D12]"}`}>
            My Orders
          </span>
        </button>
        ...
        <button className="flex items-center gap-[8px] h-[30px] w-[81px] text-left text-[#0A0D12] hover:text-[#C12116] transition-colors cursor-pointer group">
          ...
          <span className="text-[16px] font-[500] tracking-[-3%]">
            Logout
          </span>
        </button>
      </div>
