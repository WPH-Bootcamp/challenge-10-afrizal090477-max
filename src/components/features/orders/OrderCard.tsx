...
export const OrderCard: React.FC<OrderCardProps> = ({
  ...
  const displayRestaurantLogo =
    order.restaurantLogo || "/icons/Burger-Bang.png";
  const displayFoodName = order.foodName || "Food Name";
  const displayFoodImage = order.foodImage || "Food Image";
    ...
    >
      <div className="flex items-center gap-[8px] h-[32px]">
        <div className="relative w-[32px] h-[32px] rounded-full overflow-hidden bg-slate-50 border border-slate-100">
          <Image
            src={displayRestaurantLogo}
            alt={displayRestaurantName}
            fill
            sizes="32px"
            onError={(e) => {
              e.currentTarget.src = "/public/icons/mcdonalds.png";
            }}
      ...
      <div className="w-full flex items-center justify-between h-[80px]">
        <div className="flex items-center gap-[17px] h-[80px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <span className="text-[16px] font-[800] text-[#0A0D12] mt-1">
      ...
      <div className="w-full flex items-center justify-between h-[48px]">
        <div className="flex flex-col justify-center">
          ...
          <span className="text-[20px] font-[800] text-[#0A0D12] mt-0.5">
        ...
        <Button
          ...
          className="w-[240px] h-[48px] rounded-[200px] bg-[#C12116] hover:bg-[#a81c12] text-white text-[15px] font-[700]"
        >
          Give Review
        </Button>
      </div>
